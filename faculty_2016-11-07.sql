...
# Database: faculty
# Generation Time: 2016-11-07 07:17:15 +0000
# ************************************************************
...
# Dump of table faculty_ad
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_ad`;

CREATE TABLE `faculty_ad` (
...
# Dump of table faculty_asset
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_asset`;

CREATE TABLE `faculty_asset` (
...
# Dump of table faculty_auth_access
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_auth_access`;

CREATE TABLE `faculty_auth_access` (
...
LOCK TABLES `faculty_auth_access` WRITE;
/*!40000 ALTER TABLE `faculty_auth_access` DISABLE KEYS */;

INSERT INTO `faculty_auth_access` (`role_id`, `rule_name`, `type`)
VALUES
	(2,'portal/setting/save','admin_url'),
	(2,'portal/setting/index','admin_url');

/*!40000 ALTER TABLE `faculty_auth_access` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_auth_rule
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_auth_rule`;

CREATE TABLE `faculty_auth_rule` (
...
LOCK TABLES `faculty_auth_rule` WRITE;
/*!40000 ALTER TABLE `faculty_auth_rule` DISABLE KEYS */;

INSERT INTO `faculty_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`)
VALUES
	...
	(174,'Portal','admin_url','portal/setting/index',NULL,'主页设置',1,''),
	(175,'Portal','admin_url','portal/setting/save',NULL,'上传设置',1,'');

/*!40000 ALTER TABLE `faculty_auth_rule` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_comments
# ------------------------------------------------------------
...
# Dump of table faculty_common_action_log
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_common_action_log`;

CREATE TABLE `faculty_common_action_log` (
...
# Dump of table faculty_content
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_content`;

CREATE TABLE `faculty_content` (
...
LOCK TABLES `faculty_content` WRITE;
/*!40000 ALTER TABLE `faculty_content` DISABLE KEYS */;

INSERT INTO `faculty_content` (`id`, `type`, `address`, `imgSrc`, `email`, `name`, `mobile`, `company`)
VALUES
	(1,1,'学科楼541',NULL,'b15011828@njupt.edu.cn','崔天悦','15601597173',NULL);

/*!40000 ALTER TABLE `faculty_content` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_guestbook
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_guestbook`;

CREATE TABLE `faculty_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
# Dump of table faculty_links
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_links`;
...
LOCK TABLES `faculty_links` WRITE;
/*!40000 ALTER TABLE `faculty_links` DISABLE KEYS */;

INSERT INTO `faculty_links` (`link_id`, `link_url`, `link_name`, `link_image`, `link_target`, `link_description`, `link_status`, `link_rating`, `link_rel`, `listorder`)
VALUES
	(1,'http://www.thinkcmf.com','ThinkCMF','','_blank','',1,0,'',0);

/*!40000 ALTER TABLE `faculty_links` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_menu`;

CREATE TABLE `faculty_menu` (
...
LOCK TABLES `faculty_menu` WRITE;
/*!40000 ALTER TABLE `faculty_menu` DISABLE KEYS */;

INSERT INTO `faculty_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`)
VALUES
	...
	(187,0,'Portal','Setting','index','',1,1,'主页设置','cogs','',0),
	(188,187,'Portal','Setting','save','',1,1,'保存设置','','',0);

/*!40000 ALTER TABLE `faculty_menu` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_nav
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_nav`;

CREATE TABLE `faculty_nav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `faculty_nav` WRITE;
/*!40000 ALTER TABLE `faculty_nav` DISABLE KEYS */;

INSERT INTO `faculty_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`)
VALUES
...
/*!40000 ALTER TABLE `faculty_nav` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_nav_cat
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_nav_cat`;

CREATE TABLE `faculty_nav_cat` (
...
LOCK TABLES `faculty_nav_cat` WRITE;
/*!40000 ALTER TABLE `faculty_nav_cat` DISABLE KEYS */;

INSERT INTO `faculty_nav_cat` (`navcid`, `name`, `active`, `remark`)
VALUES
	(1,'主导航',1,'主导航');

/*!40000 ALTER TABLE `faculty_nav_cat` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_oauth_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_oauth_user`;

CREATE TABLE `faculty_oauth_user` (
...
# Dump of table faculty_options
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_options`;
...
LOCK TABLES `faculty_options` WRITE;
/*!40000 ALTER TABLE `faculty_options` DISABLE KEYS */;

INSERT INTO `faculty_options` (`option_id`, `option_name`, `option_value`, `autoload`)
VALUES
	...
	(6,'site_options','            {\n            		\"site_name\":\"南京邮电大学计算机学院软件学院教室个人主页系统\",\n            		\"site_host\":\"http://127.0.0.1/\",\n            		\"site_root\":\"\",\n            		\"site_icp\":\"\",\n            		\"site_admin_email\":\"b15011828@njupt.edu.cn\",\n            		\"site_tongji\":\"\",\n            		\"site_copyright\":\"\",\n            		\"site_seo_title\":\"南京邮电大学计算机学院软件学院教室个人主页系统\",\n            		\"site_seo_keywords\":\"南京邮电大学\",\n            		\"site_seo_description\":\"\"\n        }',1);

/*!40000 ALTER TABLE `faculty_options` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_page
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_page`;
...
LOCK TABLES `faculty_page` WRITE;
/*!40000 ALTER TABLE `faculty_page` DISABLE KEYS */;

INSERT INTO `faculty_page` (`id`, `admincode`, `pagetype`, `url`)
VALUES
	(1,1,1,NULL),
	(2,3,1,NULL);

/*!40000 ALTER TABLE `faculty_page` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_plugins
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_plugins`;

CREATE TABLE `faculty_plugins` (
...
INSERT INTO `faculty_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`)
VALUES
	(1,'超级管理员',0,1,'拥有网站最高管理员权限！',1329633709,1329633709,0),
	(2,'教师账号',NULL,1,'',1478224575,0,0);

/*!40000 ALTER TABLE `faculty_role` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_role_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_role_user`;

CREATE TABLE `faculty_role_user` (
...
LOCK TABLES `faculty_role_user` WRITE;
/*!40000 ALTER TABLE `faculty_role_user` DISABLE KEYS */;

INSERT INTO `faculty_role_user` (`role_id`, `user_id`)
VALUES
	(2,3);

/*!40000 ALTER TABLE `faculty_role_user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_route
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_route`;

CREATE TABLE `faculty_route` (
...
# Dump of table faculty_slide
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_slide`;

CREATE TABLE `faculty_slide` (
...
# Dump of table faculty_slide_cat
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_slide_cat`;

CREATE TABLE `faculty_slide_cat` (
...
# Dump of table faculty_term_relationships
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_term_relationships`;

CREATE TABLE `faculty_term_relationships` (
...
# Dump of table faculty_terms
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_terms`;
...
LOCK TABLES `faculty_terms` WRITE;
/*!40000 ALTER TABLE `faculty_terms` DISABLE KEYS */;

INSERT INTO `faculty_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`)
VALUES
	(1,'列表演示','','article','',0,0,'0-1','','','','list','article',0,1),
	(2,'瀑布流','','article','',0,0,'0-2','','','','list_masonry','article',0,1);

/*!40000 ALTER TABLE `faculty_terms` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table faculty_user_favorites
# ------------------------------------------------------------

DROP TABLE IF EXISTS `faculty_user_favorites`;

CREATE TABLE `faculty_user_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `faculty_users` WRITE;
/*!40000 ALTER TABLE `faculty_users` DISABLE KEYS */;

INSERT INTO `faculty_users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`, `coin`, `mobile`, `realname`)
VALUES
	(1,'admin','###a953c71d9dacaf27abbde75e4058f796','admin','b15011828@njupt.edu.cn','',NULL,0,NULL,NULL,'127.0.0.1','2016-11-06 23:13:17','2016-11-03 09:39:50','',1,0,1,0,'',NULL),
	(3,'test','###5bdcdba53c42da48fdb394bfa20af04c','cuitianyue','c@s.com','',NULL,0,NULL,NULL,'127.0.0.1','2016-11-06 23:15:31','2016-11-06 23:15:09','',1,0,1,0,'','cuitianyue');

/*!40000 ALTER TABLE `faculty_users` ENABLE KEYS */;
UNLOCK TABLES;
